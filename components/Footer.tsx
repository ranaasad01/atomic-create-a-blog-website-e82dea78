        ...
        <div className="border-t border-stone-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-8 h-8 rounded-lg bg-stone-800 hover:bg-amber-400 hover:text-stone-900 flex items-center justify-center text-stone-400 transition-colors duration-200"
